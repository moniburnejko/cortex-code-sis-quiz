...
| 2 - claude-sonnet-4-5 model | PASS / FAIL | raw error if FAIL |
...
- The model name in quiz.py (`CORTEX_MODEL = "claude-sonnet-4-5"`) must match an available model from Step 5
